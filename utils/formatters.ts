// https://github.com/discordjs/builders/blob/3c596b0a851b0c3d64edbeb776180e53eee14523/src/messages/formatters.ts
 ...
 */
export function hyperlink<C extends string>(
  content: C,
  url: URL
): `[${C}](${string})`;
/**
 ...
 * @param url The URL the content links to
 */
export function hyperlink<C extends string, U extends string>(
  content: C,
  url: U
): `[${C}](${U})`;
/**
 ...
 */
export function memberNicknameMention<C extends Snowflake>(
  memberId: C
): `<@!${C}>` {
  return `<@!${memberId}>`;
}
 ...
 */
export function time<S extends TimestampStylesString>(
  date: Date,
  style: S
): `<t:${bigint}:${S}>`;
/**
 ...
 * @param style The style to use
 */
export function time<C extends number, S extends TimestampStylesString>(
  seconds: C,
  style: S
): `<t:${C}:${S}>`;
export function time(
  timeOrSeconds?: number | Date,
 ...
 */
export type TimestampStylesString =
